...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        groupeaccount.add(r1);
        groupeaccount.add(r2);
        ...
        groupscitizen.add(r3);
        groupscitizen.add(r4);
        ...
        getContentPane().setBackground(Color.WHITE);//getContentPane().setBackground(new Color(0xRRGGBB));
